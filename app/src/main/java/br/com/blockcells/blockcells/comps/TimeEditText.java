package br.com.blockcells.blockcells.comps;
...
// TODO Auto-generated constructor stub
    ...
    public String getCleanText() {
        String text = TimeEditText.this.getText().toString();
...
*/
                isUpdating = true;
                TimeEditText.this.setText(time);

                TimeEditText.this.setSelection(positioning[length]);
